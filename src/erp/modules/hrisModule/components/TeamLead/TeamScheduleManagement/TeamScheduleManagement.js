...
let TeamScheduleManagement = class TeamScheduleManagement extends Vue {
    constructor() {
        super(...arguments);
        this.employees = [];
    }
...
TeamScheduleManagement = tslib_1.__decorate([
    Component({
...
export default TeamScheduleManagement;
class employeeSchedule {
}
//# sourceMappingURL=TeamScheduleManagement.js.map